...
# Force IPv4 for OpenAI-related outbound requests
# Default: True, can be disabled by setting OPENAI_FORCE_IPV4=false
OPENAI_FORCE_IPV4 = os.environ.get("OPENAI_FORCE_IPV4", "True").lower() == "true"
